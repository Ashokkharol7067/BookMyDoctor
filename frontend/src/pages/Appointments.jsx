      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <div className='flex items-center gap-3 mt-4'>
          ...
          <input
            ...
            className='border border-gray-300 rounded-lg px-3 py-2 text-sm cursor-pointer outline-none'
          />
        ...
        <button
          ...
          className='border rounded-full my-6 px-14 py-3 font-light text-white text-sm bg-primary'
        >
          Book an appointment
        </button>
