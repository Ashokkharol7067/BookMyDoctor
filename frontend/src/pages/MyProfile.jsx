  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700 '>
          ...
          <p className='font-medium '>Address: </p>
          {
            ...
            ? <p >
              ...
              <br />
              <inpu className='bg-gray-50' type="text" onChange={e => setUserData(prev => ({...prev, address: {...prev.address, line2: e.target.value}}))} value={userData.address.line2}/>
            </p>
      ...
      <div className='mt-10 '>
        {
          isEdit
          ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white translate-x-full' onClick={updateUserProfileData}>Save information</button>
          : <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white translate-x-full' onClick={()=> setIsEdit(true)}>Edit</button>
        }
      </div>
