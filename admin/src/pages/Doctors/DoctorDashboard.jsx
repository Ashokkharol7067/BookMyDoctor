...
const DoctorDashboard = () => {
  const { dashData, setDashData, getDashData, dToken, completeAppointments, cancelAppointments } =
        ...
        <div className="bg-white">
          ...
          <div className="pt-4 border border-t-0">
            {dashData.latestAppointments.map((item, index) => (
              <div
                className="flex items-center px-3 py-3 gap-3 hover:bg-gray-100"
                key={index}
              >
                <img
                ...
                {item.cancelled ? (
                  <p className="text-red-400 text-xs font-medium ml-auto">Cancelled</p>
                ) : item.isCompleted ? (
                  <p className="text-green-500 text-xs font-medium ml-auto">
                    Completed
                  </p>
                ) : (
                  <div className="flex">
