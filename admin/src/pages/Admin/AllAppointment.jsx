          ...
          appointments.map((item, index) => ( 
            <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50'>
              ...
              <div className='flex items-center gap-2'>
                <img  className="w-10 h-10 rounded-full object-cover" src={item.userData.image}  /> <p>{item.userData.name}</p>
              </div>
              ...
              <div className='flex items-center gap-2'>
                <img  className="w-10 h-10 rounded-full object-cover bg-gray-200" src={item.docData.image}  /> <p>{item.docData.name}</p>
              </div>
